...
+ ¿Qué partes del código no estaban cubiertas?
    - Las partes del código que no estaban cubiertas eran cuando pudiera haber una lista vacia o cuando las notas se salian del rango de 0 - 10.
+ ¿Qué tests has añadido?
    - Se añadieron dos tests, uno para comprobar que las lista no fuera vacia y otro para comprobar que las notas estaban dentro del rango 0 - 10.
+ ¿Qué cobertura final has obtenido?
    - Al ejecutar los tests como se ve en la captura de arriba, la cobertura es superior al 90%.
